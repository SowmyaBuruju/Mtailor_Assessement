...
from custom_model import Classifier, BasicBlock
import torch
...
# Load pretrained weights directly from torchvision
checkpoint = models.resnet18(pretrained=True).state_dict()
model.load_state_dict(checkpoint, strict=False)

# Save weights
os.makedirs("weights", exist_ok=True)
torch.save(model.state_dict(), "weights/pytorch_model_weights.pth")
...
if __name__ == "__main__":
    ...
    mtailor.load_state_dict(pretrained_model.state_dict(), strict=False)
    mtailor.eval()

    # Preprocess image and infer
